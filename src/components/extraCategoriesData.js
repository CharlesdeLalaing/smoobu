export const extraCategoriesRaw = {
  ...
  meals: {
    ...
    items: [
      {
        id: "pouletTikkaMasala",
        name: "extras.meals.pouletTikkaMasala.name",
        defaultName: "Chicken Tikka Masala",
        defaultFrenchName: "Poulet Tikka Massala",
        descriptionKey: "extras.meals.pouletTikkaMasala.description",
        price: 20,
        imageIdentifier: "poulettikkamasala",
        typeKey: "extras.types.meal",
      },
      {
        id: "boulettesSauceTomate",
        name: "extras.meals.boulettesSauceTomate.name",
        defaultName: "Meatballs in tomato sauce",
        defaultFrenchName: "Boulettes sauce tomate",
        descriptionKey: "extras.meals.boulettesSauceTomate.description",
        price: 20,
        imageIdentifier: "boulettesaucetomates",
        typeKey: "extras.types.meal",
      },
      {
        id: "linguinesAuSaumon",
        name: "extras.meals.linguinesAuSaumon.name",
        defaultName: "Linguine with smoked salmon",
        defaultFrenchName: "Linguines au saumon fumé",
        descriptionKey: "extras.meals.linguinesAuSaumon.description",
        price: 20,
        imageIdentifier: "linguineausaumons",
        typeKey: "extras.types.meal",
      },
      {
        id: "risottoALaTartufata",
        name: "extras.meals.risottoALaTartufata.name",
        defaultName: "Risotto with tartufata",
        defaultFrenchName: "Risotto à la tartufata",
        descriptionKey: "extras.meals.risottoALaTartufata.description",
        price: 20,
        imageIdentifier: "risottoalatruffe",
        typeKey: "extras.types.meal",
      },
    ],
  },
