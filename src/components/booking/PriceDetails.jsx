...
export const PriceDetails = ({
  ...
  const extraGuests = Math.max(
    0,
    totalGuests - priceDetails.settings.startingAtGuest
  );
  const totalGuestFees =
    extraGuests * priceDetails.settings.extraGuestsPerNight;
  ...
  const subtotalBeforeDiscounts =
    priceDetails.originalPrice + extrasTotal + totalGuestFees;
  ...
  return (
    <div className="p-4 mt-4 overflow-y-auto rounded-lg bg-gray-50 max-h-48 sm:max-h-56 md:max-h-72 lg:max-h-80">
