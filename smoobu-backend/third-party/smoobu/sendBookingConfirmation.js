...
const emailTexts = {
  ...
  en: {
    ...
    glampingInfoText:
      'It is important to know that, being Glamping, this is more luxurious camping in nature. This means that in wet/rainy weather, we strongly advise you not to wear your best shoes for the trips from your vehicle to the accommodation and vice versa. The path can be wet and sometimes a bit muddy. The heating available takes a few minutes to warm up.\n\nAn outdoor shower is available in the spa area at no extra charge. We simply ask that you let us know what time you plan to use it so that we can avoid any simultaneous bookings for the spa. <strong>In the event of freezing temperatures, the shower may not be operational.</strong> The spa is located on the farm, approximately 100 metres from the unusual accommodation.',
    ...
    extrasCatalog: {
      ...
      "drinkNames.bruneCondroz": "Brune de Leignion (Beer)",
      "drinkNames.ambreeCondroz": "Ambrée à la Cardamome (Beer)",
      "drinkNames.tripleCondroz": "Triple de Leignion (Beer)",
      "drinkNames.blancheCondroz": "Blanche à la Bergamote (Beer)",
      "drinkNames.blondeCereales": "Blonde aux 4 Céréales (Beer)",
  ...
  nl: {
    ...
    extrasCatalog: {
      ...
      "drinkNames.bruneCondroz": "Brune de Leignion (Bier)",
      "drinkNames.ambreeCondroz": "Ambrée à la Cardamome (Bier)",
      "drinkNames.tripleCondroz": "Triple de Leignion (Bier)",
      "drinkNames.blancheCondroz": "Blanche à la Bergamote (Bier)",
      "drinkNames.blondeCereales": "Blonde aux 4 Céréales (Bier)",
